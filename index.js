...
startGame = () => {
  ...
  grid.style.background = "lemonchiffon";
};
...
move = () => {
  ...
  // add square in direction we are heading on the board
  ...
  if (
    ...
    // if snake has hit right
    (currentSnake[0] % width === width - 1 && direction === 1) ||
    // if snake has hit left
    (currentSnake[0] % width === 0 && direction === -1) ||
    // if snake has hit top
    (currentSnake[0] - width < 0 && direction === -width) ||
    // if snake has hit a snake
